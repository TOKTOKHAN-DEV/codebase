 ...
 * // TimerContainer.tsx
 * import React from 'react';
 * import { TimerProvider } from '@codebase/react-universal';
 ...
 * ```tsx
 * import React from 'react';
 * import { useTimerContext } from '@codebase/react-universal';
 *
 * const TimerDisplay = () => {
 *   // 불필요한 리랜더링 방지를 위해 selector로 가져오시는 것을 권장합니다.
 *   const time = useTimerContext((ctx) => ctx?.time)
 ...
 * // TimerContainer.tsx
 * import React from 'react';
 * import { withTimerProvider, useTimerContext } from '@codebase/react-universal';
 *
 * const TimerContainer = () => {
 *   return <TimerDisplay />;
 * };
